...
public class Coordinate
{
    ...
    public static Coordinate WorldPointToCoordinate(Vector3 point) => new Coordinate(Mathf.FloorToInt(point.x), Mathf.FloorToInt(point.y));

    public static Vector2 CoordinatetoWorldPoint(Coordinate coor) => new Vector2(coor.X + 0.5f, coor.Y + 0.5f);
}